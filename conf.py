...
conf = {
    ...
    'N_GAME_PROCESS': 16,  # number of game processes per server
    ...
    'EPOCHS_PER_BACKUP': 50,  # auto-save model to 'backup.h5' (overwrite if existing) after this number of epoch
