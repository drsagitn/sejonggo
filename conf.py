...
conf = {
    ...
    'MCTS_SIMULATIONS_PROCESSES': 8,  # number of processes to simulate MCTS
    'ENERGY': 350, # energy for async simulation
    ...
    ### TRAIN ###
    'EPOCHS_PER_SAVE': 5,  # A model will be saved to be evaluated this amount of epochs, 1000 in paper
